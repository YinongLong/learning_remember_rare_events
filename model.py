...
class LeNet(object):
    ...
    def __init__(self, image_size, num_channels, hidden_dim):
        """
        定义一个标准的CNN网络结构，用来对指定大小的图像进行embedding
        """
...
class Model(object):
    ...
    def __init__(self, input_dim, output_dim, rep_dim, memory_size, vocab_size, learning_rate=0.0001, use_lsh=False):
    ...
    def core_builder(self, x, y, keep_prob, use_recent_idx=True):
        ...
        memory_val, _, teacher_loss = self.memory.query(embeddings, y, use_recent_idx=use_recent_idx)
